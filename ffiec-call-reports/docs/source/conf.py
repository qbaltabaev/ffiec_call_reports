...
# ffiec_call_reports documentation build
...
from ffiec_call_reports import __version__ as release

# -- Project information -----------------------------------------------------

project = "ffiec_call_reports"
author = "Kedro"
...
htmlhelp_basename = "ffiec_call_reportsdoc"
...
latex_documents = [
    (
        master_doc,
        "ffiec_call_reports.tex",
        "ffiec_call_reports Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "ffiec_call_reports",
        "Project ffiec_call_reports codebase.",
        "Data-Science",
    )
]
